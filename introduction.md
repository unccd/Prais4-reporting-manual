...
In line with decision 11/COP.14, Conservation International has further enhanced and expanded [Trends.Earth](http://trends.earth/docs/en/) to support the preparation and analysis of data for UNCCD national reporting in a format that can be automatically transferred to PRAIS.
